...
-----------------------------------*/
    $('.pro-thumb-img').slick({
        ...
        infinite: true,
        slidesToShow: 4,
        prevArrow: '<button type="button" class="slick-prev"><i class="zmdi zmdi-arrow-left"></i></button>',
        nextArrow: '<button type="button" class="slick-next"><i class="zmdi zmdi-arrow-right"></i></button>',
        responsive: [
            {
                breakpoint: 1199,
                settings: {
